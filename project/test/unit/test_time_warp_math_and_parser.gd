...
func test_parser_accepts_nanoseconds_without_space() -> void:
	var parsed_value: float = TimeWarpParser.parse_input_text_to_simulated_seconds_per_real_second("1ns")
...
func test_parser_accepts_microseconds_with_us_spelling() -> void:
	var parsed_value: float = TimeWarpParser.parse_input_text_to_simulated_seconds_per_real_second("100 us")
...
func test_parser_accepts_microseconds_with_mu_symbol() -> void:
	var parsed_value: float = TimeWarpParser.parse_input_text_to_simulated_seconds_per_real_second("100 µs")
	assert_almost_eq(parsed_value, 100.0e-6, 1.0e-9,
			"'100 µs' (real micro symbol) should parse the same as '100 us'.")


func test_parser_is_case_insensitive() -> void:
	var parsed_value: float = TimeWarpParser.parse_input_text_to_simulated_seconds_per_real_second("500 NS")
...
func test_parser_accepts_decimal_numeric_value() -> void:
	var parsed_value: float = TimeWarpParser.parse_input_text_to_simulated_seconds_per_real_second("1.5 ns")
...
func test_parser_rejects_value_above_one_thousand() -> void:
	var parsed_value: float = TimeWarpParser.parse_input_text_to_simulated_seconds_per_real_second("1001 ns")
...
func test_parser_accepts_zero_as_pause_sentinel() -> void:
	var parsed_value: float = TimeWarpParser.parse_input_text_to_simulated_seconds_per_real_second("0 ns")
...
func test_parser_rejects_negative() -> void:
	var parsed_value: float = TimeWarpParser.parse_input_text_to_simulated_seconds_per_real_second("-1 ns")
	assert_true(is_nan(parsed_value),
			"Negative values must be rejected.")


func test_parser_rejects_unknown_unit() -> void:
	var parsed_value: float = TimeWarpParser.parse_input_text_to_simulated_seconds_per_real_second("100 ms")
	assert_true(is_nan(parsed_value),
			"Milliseconds aren't in the supported ps/ns/us set.")


func test_parser_rejects_missing_unit() -> void:
	var parsed_value: float = TimeWarpParser.parse_input_text_to_simulated_seconds_per_real_second("100")
	assert_true(is_nan(parsed_value),
			"Bare number with no unit must be rejected — semantics would be ambiguous.")


func test_parser_rejects_empty_string() -> void:
	var parsed_value: float = TimeWarpParser.parse_input_text_to_simulated_seconds_per_real_second("")
	assert_true(is_nan(parsed_value),
